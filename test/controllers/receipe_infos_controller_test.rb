...
class ReceipeInfosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create receipe_info" do
    assert_difference("ReceipeInfo.count") do
      post receipe_infos_url, params: { receipe_info: { body: @receipe_info.body, posted_at: @receipe_info.posted_at, title: @receipe_info.title } }
    end
  ...
  test "should update receipe_info" do
    patch receipe_info_url(@receipe_info), params: { receipe_info: { body: @receipe_info.body, posted_at: @receipe_info.posted_at, title: @receipe_info.title } }
